  ...
  public void TestJobPopulatedWithDeliverables() {
    ...
    try {
      event = seniorProducer.collectDetails(
        ...
        "2022-12-18",
        "22:00",
        "Blues @ Midwest Band Clinic Chicago",
  ...
  public void TestUpdatePaoRequest() {
    ...
    if (producer != null) {
      ...
      if (job != null) {
        ...
        job.getRequest().getEvent().setDescription("U.S. Army Blues Ellington Nutcracker @ Midwest");
